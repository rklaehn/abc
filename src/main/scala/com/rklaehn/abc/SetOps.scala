...
private[abc] object SetOps {
  ...
  def binarySearch[@sp T](a: Array[T], e: T, from: Int, until: Int)(implicit o:Order[T]): Int = {
  ...
  def intersects[@sp T: Order](a: Array[T], b: Array[T]): Boolean = {
    try {
  ...
  sealed trait BooleanOperation[@sp T] extends spire.math.BinaryMerge {
  ...
  final class SubsetOf[@sp T](val a: Array[T], val b: Array[T], val order: Order[T]) extends BooleanOperation[T] {
  ...
  final class NoIntersect[@sp T](val a: Array[T], val b: Array[T], val order: Order[T]) extends BooleanOperation[T] {
  ...
  sealed trait AbstractMerge[@sp T] extends spire.math.BinaryMerge {
  ...
  final class UnionMerge[@sp T](val a: Array[T], val b: Array[T], val r: Array[T], val order: Order[T]) extends AbstractMerge[T] {
  ...
  final class IntersectionMerge[@sp T](val a: Array[T], val b: Array[T], val r: Array[T], val order: Order[T]) extends AbstractMerge[T] {
  ...
  final class DiffMerge[@sp T](val a: Array[T], val b: Array[T], val r: Array[T], val order: Order[T]) extends AbstractMerge[T] {
  ...
  final class XorMerge[@sp T](val a: Array[T], val b: Array[T], val r: Array[T], val order: Order[T]) extends AbstractMerge[T] {
